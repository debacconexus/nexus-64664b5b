...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Supply Network Vendor Coordination";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Vendor";
process.env.TABLE_NAME = process.env.TABLE_NAME || "vendor_records";
'use strict';
